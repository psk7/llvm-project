...
public:
  ...
  enum VariantKind {
    ...
    VK_Z80_HI8,  ///< Corresponds to `hi8()`.
    VK_Z80_LO8,  ///< Corresponds to `lo8()`.
    VK_Z80_HH8,  ///< Corresponds to `hlo8() and hh8()`.
    VK_Z80_HHI8, ///< Corresponds to `hhi8()`.

    VK_Z80_PM_LO8, ///< Corresponds to `pm_lo8()`.
    VK_Z80_PM_HI8, ///< Corresponds to `pm_hi8()`.
    VK_Z80_PM_HH8, ///< Corresponds to `pm_hh8()`.

    VK_Z80_LO8_GS, ///< Corresponds to `lo8(gs())`.
    VK_Z80_HI8_GS, ///< Corresponds to `hi8(gs())`.
    VK_Z80_GS, ///< Corresponds to `gs()`.
  };
