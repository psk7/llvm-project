...
bool Z80DAGToDAGISel::selectMultiplication(llvm::SDNode *N) {

  llvm_unreachable("Z80DAGToDAGISel::selectMultiplication");
  ...
  unsigned MachineOp = isSigned ? Z80::MULSRdRr : Z80::MULRdRr;
  ...
  if (N->hasAnyUseOfValue(0)) {
    SDValue CopyFromLo =
        CurDAG->getCopyFromReg(InChain, DL, Z80::R0, Type, InGlue);
  ...
  if (N->hasAnyUseOfValue(1)) {
    SDValue CopyFromHi =
        CurDAG->getCopyFromReg(InChain, DL, Z80::R1, Type, InGlue);
