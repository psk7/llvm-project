//===- PDPShift.cpp - Shift Expansion Pass --------------------------------===//
//
...
/// inline loops, just like PDP-gcc. This must be done in IR because otherwise
...
class PDPShiftExpand : public FunctionPass {
public:
  static char ID;

  PDPShiftExpand() : FunctionPass(ID) {}

  bool runOnFunction(Function &F) override;

  StringRef getPassName() const override { return "PDP Shift Expansion"; }
...
char PDPShiftExpand::ID = 0;

INITIALIZE_PASS(PDPShiftExpand, "PDP-shift-expand", "PDP Shift Expansion",
                false, false)

Pass *llvm::createPDPShiftExpandPass() { return new PDPShiftExpand(); }

bool PDPShiftExpand::runOnFunction(Function &F) {
...
void PDPShiftExpand::expand(BinaryOperator *BI) {
